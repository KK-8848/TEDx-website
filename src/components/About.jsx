  ...
  return (
    <div className={`scrolling-text-container ${className}`}>
      <div className={`scrolling-text ${dark ? "text-[#fafafa]" : "text-[#161616]"} ${direction} `}>
        {Array(20).fill(direction === "right" ? reversedText : text).join(" ")}
      </div>
    </div>
  );
};
...
export const About = () => {
  ...
  {/* Left Section */}
  <div className="w-full lg:w-1/2  bg-[#161616] flex flex-col gap-7 overflow-hidden items-center pl-8 sm:pl-16 lg:pl-28 pb-10 sm:pb-18  min-h-screen ">
    <div className="flex flex-col gap-4 lg:mt-4  items-center lg:items-start">
      <div className="mb-4 text-5xl sm:text-8xl lg:text-9xl  text-[#fafafa] font-vanguard leading-tight lg:leading-[148px] font-extrabold">
        ABOUT
      </div>
      <p className="w-full max-w-[99%] md:max-w-[510px] text-xl md:text-3xl text-[#fafafa] font-avantgarde leading-[1.8rem] sm:leading-[2.2rem] tracking-wide">
...
<div className="flex flex-col lg:flex-row w-[100%] lg:w-20 h-[80px] lg:h-screen items-center justify-center">
  <div className="w-[100%] lg:w-10 lg:h-screen flex-1 bg-[#161616] border-[#fafafa] border-t-2 lg:border-l-2 lg:border-t-0">
      <ScrollingText className="w-full h-full" dark direction="left"/>
  </div>


  
  <div className="w-[100%] lg:w-10 lg:h-screen flex-1 border-[#161616] bg-[#fafafa] border-b-2 lg:border-r-2 lg:border-b-0">
    <ScrollingText className="w-full h-full md:vertical" direction="right"/>
  </div>
</div>
